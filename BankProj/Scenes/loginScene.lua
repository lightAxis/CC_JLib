...
function SCENE:initialize(attachedScreen, ProjTemplatespace)
    ...
    self.tb1 = JLib.TextBlock:new(self.rootScreenCanvas, self.attachingScreen,
                                  "tb1")
    self.tb1:setText("IDs")
    self:tb1_style(self.tb1)
    self.tb1.PosRel, self.tb1.Len = grid:getPosLen(2, 1, 2, 1)

    self.lb1 = JLib.ListBox:new(self.rootScreenCanvas, self.attachingScreen,
                                "listbox1")
    self.lb1.PosRel, self.lb1.Len = grid:getPosLen(2, 2, 2, 1)
    ...
    self.butt1.PosRel, self.butt1.Len = grid:getPosLen(2, 4, 1, 1)
    ...
    self.butt2.PosRel, self.butt2.Len = grid:getPosLen(3, 4, 1, 1)
